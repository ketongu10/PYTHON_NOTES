...
checkpoint_path = ("/home/popovpe/Projects/WaterTrain/owl.guard.cv/cyclops/training/liquid_seg/"
                   "many_class_experiments/mobile_w_luja_better/outputs/run_training/"
                   "mblfrmr_w_lujas_better_2025-06-16_14-18-38/checkpoints/last.ckpt")
# trans = AugmentationsPreset.identity_transform.value
# model = SegmentationModel.load_from_checkpoint(checkpoint_path, map_location="cuda:0")
# model.eval()

DATASETS_FOR_RUN = {
    "/home/popovpe/Projects/VasiasAutoloader/autoloader/approved_lujas": "lujas",
...
output_dir = Path(f"/vol2/WATER/RUNS/SEG/106/mbfrmr_lujas_better_conf={CONFS['water']}_denc={DENC*100:0.2f}%_19.06.25")
