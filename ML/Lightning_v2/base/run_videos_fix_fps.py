...
from dataloader_seg import GeneralDataset, AugmentationsPreset, IMAGE_SIZE
    ...
    while cont:
        try:
            with torch.no_grad():
                ...
                mask_zero = np.zeros(shape=(h,w, 3), dtype=int)
                mask_zero[..., 1] = mask
                mask = mask_zero
                ...
                #print(f"mask: {np.shape(mask)}| img: {np.shape(show)}| {(mask.dtype)} | {(frame0.dtype)}")
...
checkpoint_path = ("/home/popovpe/Projects/WaterTrain/owl.guard.cv/cyclops/training/liquid_seg/experiments/segformer_w_real/outputs/down/test_f1.ckpt")
# trans = AugmentationsPreset.identity_transform.value
...
DATASETS_FOR_RUN = {
    ...
    # "/home/popovpe/Projects/WaterDif/VideosForRun/ForCompareMan1-2": "manual12",
    # "/home/popovpe/Projects/WaterDif/VideosForRun/ForCompareMan3": "manual3",
...
output_dir = Path(f"/vol2/WATER/RUNS/SEG/106/segformer_down+afp_conf={CONF}_denc={DENC*100:0.2f}%_11.04.25")
